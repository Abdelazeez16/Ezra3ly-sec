<template>
    <!-- component -->
<div class="bg-white relative   flex items-center  n justify-center overflow-hidden z-50" id="about">
         ...
         <div class="flex flex-col items-center justify-between lg:flex-row py-16">
             <div class=" relative ">
                 <div class=" absolute top-0 -left-48 z-0  ">
                     <img src="https://media.discordapp.net/attachments/1146417576675647612/1257073150638821468/Rose.png?ex=66d4285a&is=66d2d6da&hm=f49691163b6ad97205d9f716ee066995408018b058abee2e7313af6adab48d00&=&format=webp&quality=lossless&width=250&height=125" class="w-36 z-0  h-full    object-fill fill-y text-y   ">
                 </div>
                 <div class="lg:max-w-xl lg:pr-5 relative z-40">
                     ...
                     <h2 class="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                        Celebrating Individuality Empowering
                         <span class="my-1 inline-block border-b-8 border-g4 bg-white px-4 font-bold text-g4 animate__animated animate__flash"> Uniqueness</span>
                     </h2>
                     <p class="text-base text-gray-700">Ezra3ly offers data-driven agricultural insights to optimize farming practices and enhance productivity.</p>
